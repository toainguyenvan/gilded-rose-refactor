...
RSpec.describe GildedRose do
  context "APPROACH 2" do
    ...
    context "Aged Brie Items" do
      ...
      it "When sell_in passed, quality increase twice" do
        gilded_rose.update_quality
    ...
    context "Backstage passes Items" do
      context "When sell_in not passed" do
  ...
  #   it "Normal and Aged Brie" do
  #     items_expect = [
  #       Item.new("NORMAL ITEM", 4, 9),
  #       Item.new("Aged Brie", 2, 11)
  #     ]
  #     expect(items).to eq items_expect
  #   end
  # end
end
